...
public strictfp class Triangle extends Shape {
	...
	public Rectangle boundingRectangle() {
		...
		//compute height
			...
			Position heightVector = corners[excludedCorner].subtract(excludedCorner == 0 ? corners[1] : corners[0]).vectorProjection(longestEdge.orthogonal());
		//compute center
